...
window.dhtmlXScheduler = window.scheduler = {version: "4.4.4"}, window.dhtmlx || (dhtmlx = function (e) {
    ...
    setTransactionMode: function (e, t) {
        ...
        if (e) {
            ...
            if ("GET" == this._tMode) i.loadXML(r + (-1 != r.indexOf("?") ? "&" : "?") + this.serialize(e, t)); else if ("POST" == this._tMode) i.loadXML(r, !0, this.serialize(e, t)); else if ("REST" == this._tMode) {
        ...
        if (window.JSON) try {
            var r = JSON.parse(t.xmlDoc.responseText), s = r.action || this.getState(i) || "updated", a = r.sid || i[0],
                n = r.tid || i[0];
        ...
        for (var l = 0; l < o.length; l++) {
            var h = o[l], s = h.getAttribute("type"), a = h.getAttribute("sid"), n = h.getAttribute("tid");
    ...
    dhtmlxEventable(scheduler), scheduler._detachDomEvent = function (e, t, i) {
        ...
        if (this._cols) {
            ...
            if (t = r + (this._cols[t] ? (e - i) / this._cols[t] : 0), this._ignores) {
                ...
                if (t >= this._cols.length) for (; t >= 1 && this._ignores[Math.floor(t)];) t--
            }
        }
        return t
        ...
        if (this._drag_mode) {
            ...
            if (this._is_pos_changed(this._drag_pos, t)) {
                ...
                if (this._drag_pos = t, this._drag_pos.has_moved = !0, "create" == this._drag_mode) {
                    ...
                    var a = new Date(this._drag_start), n = new Date(r);
                ...
                if (scheduler.matrix && (d = scheduler.matrix[scheduler._mode]), d = d || {
                    ...
                    if (i = o.start_date.valueOf(), r = o.end_date.valueOf(), this._table_view) {
                        ...
                        var _ = this.date.date_part(new Date(o.end_date.valueOf() - 1)).valueOf(), c = new Date(_);
                ...
                var g = new Date(r - 1), f = new Date(i);
                ...
                if (!this._table_view && !scheduler.config.all_timed && (!scheduler._get_section_view() && t.x != this._get_event_sday({
                    ...
                    var v = r - f, h = this._min_date.valueOf() + 24 * t.x * 60 * 6e4;
                    r = scheduler.date.date_part(new Date(h)),
                        r.setHours(this.config.last_hour), g = new Date(r - 1), "move" == this._drag_mode && (f = new Date(+r - v))
                }
                if (this._table_view || g.getDate() == f.getDate() && g.getHours() < this.config.last_hour || scheduler._allow_dnd) if (o.start_date = f, o.end_date = new Date(r), this.config.update_render) {
        ...
        if (this.templates[this._mode + "_date"]) {
            ...
            if (this._els.dhx_cal_date[0].innerHTML = o, this._waiAria.navBarDateAttr(this._els.dhx_cal_date[0], o), this._max_date = d, scheduler._render_scales(e, t), this._table_view) this._reset_month_scale(t, n, a); else if (this._reset_hours_scale(t, n, a), i.multi_day) {
                var l = "dhx_multi_day";
        ...
        for (var i, r = [], s = [[], [], [], [], [], [], []], a = this._colsS.heights, n = this._cols.length, d = {}, o = 0; o < e.length; o++) {
            ...
            if (l._sday = g % n, !this._ignores[l._sday] || !l._timed) {
                ...
                if (l._sorder && t || (l._sorder = v), l._sday + l._length <= n) i = null, r.push(l), m[v] = l, a[l._sweek] = m.length - 1, l._first_chunk = _.first_chunk, l._last_chunk = _.last_chunk; else {
        ...
        for (var s = e.doXPath("//coll_options"), a = 0; a < s.length; a++) {
            var n = s[a].getAttribute("for"), d = this.serverList[n];
            if (d) {
                d.splice(0, d.length);
    ...
    scheduler.ical = {
        ...
        template: {
            ...
            render: function (e) {
                ...
                var t = e.time_format, i = scheduler.config, r = this.date.date_part(scheduler._currentDate()),
                    s = 1440, a = 0;
    ...
    scheduler._init_touch_events = function () {
        ...
        function a(e) {
            var t = scheduler.getState().drag_mode, i = scheduler.matrix ? scheduler.matrix[scheduler._mode] : !1,
            ...
            s && (s.padding = 14), scheduler.templates.event_bar_date = function (e, t, i) {
                ...
                if (scheduler.templates.month_day = function (i) {
                    ...
                    for (var i = scheduler._els.dhx_cal_navline[0].getElementsByTagName("div"), r = null, s = 211, a = 0; a < i.length; a++) {
                        var n = i[a], d = n.getAttribute("name");
